...
#define SPRITE_BASE_TILE_SIZE (4*4)
...
mu8 __sprite_counter;
mu8 __inner_sprite_counter;
mu8 cursor_sprite;
mu8 inner_cursor_sprite;
u16 cursor_base_x;
const u8* sprite_pointers[POSSIBLE_SPRITES];

mu8 updated_shadow_oam;
mu8 loaded_inner_sprite_counter;
